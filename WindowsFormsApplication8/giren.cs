...
{
    public partial class giren : Form
    {
        ...
        {  
            if (dateTimePicker1.Text.Trim() != "" && dateTimePicker2.Text.Trim() != "" && textBox1.Text.Trim() != "" && textBox2.Text.Trim() != "")
            {
                ...
                int gmiktar = Convert.ToInt32(textBox2.Text);

                baglanti.Open();
                komut.Connection = baglanti;
                komut.CommandText = "INSERT INTO tablo (Tarih, Saat, Tür, Açıklama, Giren) VALUES('" + tarih + "','" + saat + "','" + tur + "','" + aciklama + "','" + gmiktar + "')";
        ...
        private void giren_Load(object sender, EventArgs e)
        {
